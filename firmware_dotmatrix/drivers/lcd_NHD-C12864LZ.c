...
void LcdLoadBitmapSetOnly(u8 const* paau8Bitmap_, PixelBlockType* psBitmapSize_)
{
  u8 u8CurrentBitMaskBitmap;
  u8 u8CurrentBitMaskLcdRAM;
  u16 u16BitGroupBitmap;
...
void LcdLoadInverseBitmapSetOnly(u8 const* paau8Bitmap_, PixelBlockType* psBitmapSize_)
{
  u8 u8CurrentBitMaskBitmap;
  u8 u8CurrentBitMaskLcdRAM;
  u16 u16BitGroupBitmap;
